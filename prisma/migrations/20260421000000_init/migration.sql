...
-- CreateEnum
CREATE TYPE "BookStatus" AS ENUM ('DRAFT', 'PENDING_REVIEW', 'ON_SALE', 'REJECTED', 'SOLD_OFF', 'REMOVED');
...
-- CreateIndex
CREATE INDEX "Book_major_idx" ON "Book"("major");
...
-- CreateIndex
CREATE UNIQUE INDEX "Conversation_bookId_buyerId_key" ON "Conversation"("bookId", "buyerId");
